...
Label(logo, text="Parthiv's CV Maker", font=('Aileron Bold', 22), fg='SlateGray4').grid(
    column=1, row=0, columnspan=5, padx=10)
Label(logo, text="Online CV Builder", font=('Penna', 15),
      fg='SlateGray4').grid(column=1, row=1, sticky=W, padx=10)
Res = Label(page, fg='SlateGray4', text='RESUME',
            font=("Times", 25, "bold")).pack(pady=10)
xm = Label(page, fg='red', text='Resume - ', font=("Times", 15)).pack(pady=2)
...
Edu_title = Label(page, fg='white', text='Educational Qualifications',
                  bg='SlateGray4', width=235).place(y=495)
...
Exp_title = Label(page, fg='white', text='Experience',
                  bg='SlateGray4', width=235).pack(pady=405)
# 1
...
Project_title = Label(page, fg='white', text='Projects',
                      bg='SlateGray4', width=235).place(y=1100)
...
Button(page, text='Next Page', fg='white', bg='SlateGray4',
