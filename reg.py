...
########################################################            PERSONAL INFO                 ###########################################################
Label(logo, text="Job", font=('Aileron Bold', 22), fg='plum4').grid(
    column=1, row=0, columnspan=5, padx=10)
Label(logo, text="CV Builder", font=('Penna', 15),
      fg='plum4').grid(column=1, row=1, sticky=W, padx=10)


Person_title = Label(page, fg='white', text='Personal Information',
                     bg='plum4', width=235).pack(pady=10)
Name = Frame(page)
Name.pack()
...
Label(page, text='Address', bg='plum4',
...
Label(address, text="Permanent:", fg='plum4',
...
Label(c_address, text="Current:", fg='plum4',
...
add_same = Checkbutton(page, text="Permanent and Current Address are the same", variable=add_svar,
                       onvalue=1, offvalue=0, width=100, fg='plum4', font=('bold', 10), command=cur_add)

add_same.pack()


#####################################################################     Educational Qualification     ############################################################
Label(page, text='Educational Qualification', bg='plum4',
...
#################################################################    Submit   #################################################################
actionbtn = Button(root, text='CANCEL', fg='white', bg='plum4',
                   width=10, command=ex).place(x=700, y=670)

actionbtn = Button(root, text='SUBMIT', fg='white', bg='plum4',
                   width=10, command=add).place(x=800, y=670)

actionbtn = Button(root, text='SIGN IN', fg='white', bg='plum4',
